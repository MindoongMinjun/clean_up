...
class So2 extends StatefulWidget {
  ...
  @override
  State<So2> createState() => _No2State();
}

class _No2State extends State<So2> {
  Future<String>? _so2Future;

  @override
  void initState() {
    super.initState();
    _so2Future = fetchMicroDustService();
  }
  ...
  Future<String> fetchMicroDustService() async {
    ...
    if (response.statusCode == 200) {
      ...
      return miocroDustService.so2; // 직접 습도 값을 반환합니다.
    } else {
      // 에러 처리
